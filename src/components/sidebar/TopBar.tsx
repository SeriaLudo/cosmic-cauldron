...
import { Flame, Snowflake, Droplets, Power, RotateCcw, Thermometer } from 'lucide-react'
...
export default function TopBar({ onTemperatureChange, onActiveChange, onReset }: TopBarProps) {
